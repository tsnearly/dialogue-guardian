...
from guardian.cli import create_parser, validate_args, main, setup_logging
...
class TestGuardianCLI(unittest.TestCase):
    ...
    def test_main_success(self):
        ...
        with patch('guardian.cli.validate_args') as mock_validate, \
            ...
            mock_print.assert_called_with("Censored video created: /output/censored.mp4")
    ...
    def test_main_processing_failure(self):
        ...
        with patch('guardian.cli.validate_args') as mock_validate, \
            ...
            self.assertEqual(result, 1)
            self.assertIn("Censoring process failed", mock_stderr.getvalue())
