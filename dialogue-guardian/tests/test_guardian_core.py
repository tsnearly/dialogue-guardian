...
class TestGuardianProcessor(unittest.TestCase):
    ...
    def test_init_default_values(self):
        ...
        self.assertEqual(processor.matching_words, GuardianProcessor.DEFAULT_MATCHING_WORDS)
    ...
    def test_extract_embedded_srt_success(self, mock_json_loads, mock_check_output):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = self.processor.extract_embedded_srt(self.test_video_path, self.test_srt_path)
    ...
    @patch('srt.parse')
    @patch('subprocess.run')
    def test_censor_audio_with_custom_output(self, mock_run, mock_srt_parse, mock_file, mock_exists):
        ...
        result = self.processor.censor_audio_with_ffmpeg(self.test_video_path, custom_output)
    ...
    def test_process_video_success(self, mock_exists):
        ...
        with patch.object(self.processor, 'get_video_details') as mock_details, \
             patch.object(self.processor, 'censor_audio_with_ffmpeg') as mock_censor:
    ...
    def test_regex_pattern_compilation(self):
        ...
        import re
        pattern = r'\b(' + '|'.join(re.escape(word) for word in self.processor.matching_words) + r')\b'
